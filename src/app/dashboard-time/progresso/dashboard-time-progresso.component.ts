...
@Component({
  selector: 'app-dashboard-time-progresso',
  templateUrl: './dashboard-time-progresso.component.html',
  styleUrls: ['./dashboard-time-progresso.component.scss']
})

export class DashboardTimeProgressoComponent {
  images: any[] = [];
  num = 1;
