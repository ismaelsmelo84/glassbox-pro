...
@Component({
  selector: 'app-dashboard-portfolio-progresso',
  templateUrl: './dashboard-portfolio-progresso.component.html',
  styleUrls: ['./dashboard-portfolio-progresso.component.scss']
})

export class DashboardPortfolioProgressoComponent {
  images: any[] = [];
  num = 1;
