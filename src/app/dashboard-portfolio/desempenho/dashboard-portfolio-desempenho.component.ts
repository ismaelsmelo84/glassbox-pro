...
@Component({
  selector: 'app-dashboard-portfolio-desempenho',
  templateUrl: './dashboard-portfolio-desempenho.component.html',
  styleUrls: ['./dashboard-portfolio-desempenho.component.scss']
})

export class DashboardPortfolioDesempenhoComponent {
