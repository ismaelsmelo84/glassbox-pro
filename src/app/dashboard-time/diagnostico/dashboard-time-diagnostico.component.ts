...
@Component({
  selector: 'app-dashboard-time-diagnostico',
  templateUrl: './dashboard-time-diagnostico.component.html',
  styleUrls: ['./dashboard-time-diagnostico.component.scss']
})

export class DashboardTimeDiagnosticoComponent {
  single: any[];
  sistemas: any[];
  capacidade: any[];
