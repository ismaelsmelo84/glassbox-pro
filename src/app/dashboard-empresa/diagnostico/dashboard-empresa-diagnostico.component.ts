...
@Component({
  selector: 'app-dashboard-empresa-diagnostico',
  templateUrl: './dashboard-empresa-diagnostico.component.html',
  styleUrls: ['./dashboard-empresa-diagnostico.component.scss']
})

export class DashboardEmpresaDiagnosticoComponent {
  single: any[];
  sistemas: any[];
  capacidade: any[];
